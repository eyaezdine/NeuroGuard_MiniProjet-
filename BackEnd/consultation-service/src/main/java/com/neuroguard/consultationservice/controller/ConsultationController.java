...
public class ConsultationController {
    ...
    public ResponseEntity<ConsultationResponse> create(
            ...
            @RequestAttribute("userId") String providerId) {   // ← anciennement Long
        ConsultationResponse response = consultationService.createConsultation(request, providerId);
    ...
    public ResponseEntity<ConsultationResponse> update(
            ...
            @Valid @RequestBody ConsultationRequest request,
            @RequestAttribute("userId") String userId,        // ← anciennement Long
    ...
    public List<ConsultationResponse> getMyConsultationsAsPatient(
            @RequestAttribute("userId") String patientId) {   // ← anciennement Long
    ...
    public List<ConsultationResponse> getMyConsultationsAsCaregiver(
            @RequestAttribute("userId") String caregiverId) { // ← anciennement Long
